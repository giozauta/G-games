...
const GamePage: React.FC = () => {
  ...
  //
  const { data: gameInfo, isLoading, isError,refetch } = useGamesById(Number(gameId));
  //
  if (isLoading) {
    return <div className="dark:bg-custom-gradient sm:h-[800px] flex justify-center items-center   w-[99%] sm:w-full mx-auto ">Loading...</div>;
  }
  if (isError) {
