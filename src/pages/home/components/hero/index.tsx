...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-between w-full h-[900px] overflow-hidden relative sm:absolute top-0 left-0 bg-gradient-to-r from-[#1d0b03] to-[#0b1900]">
      <div className="absolute top-0 left-0 w-full h-full z-0 hidden sm:flex justify-center items-center">
        <img src="/public/images/bg-1.png" alt="bg" />
      </div>

      <div className="relative  z-10 flex flex-col sm:flex-row justify-evenly sm:justify-center items-center w-full h-full ">
        <div className="x h-96 w-full sm:w-[35%] flex justify-start sm:justify-end ">
          <div className="text-7xl sm:text-8xl pl-4 sm:pl-0 font-chakra-petch text-white font-bold ">
            <div>Ultimate</div>
        ...
        <div className=" h-full w-[30%] hidden sm:flex justify-center items-end">
          <img
        ...
        <div className=" h-96 w-full  sm:w-[35%] flex justify-center sm:justify-start ">
          <div className=" bg-red w-96   flex flex-col  justify-start items-center bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-6 ">
            <div className="text-3xl font-bold flex items-center gap-2  w-full h-1/4 ">
              <div className="bg-[#F75A1D] w-4 h-4 rounded-lg "></div>Winner
              Games
            </div>
            <div className=" w-full h-3/4 flex flex-col justify-evenly ">
              <div className="flex justify-start items-center gap-10  h-1/3">
                <Avatar>
